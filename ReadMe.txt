...
- For demo of mode 1,2,4, compile and run HybridAttack with the arguments: -input testcases/test13.txt -m 160 -beta 20 -r 20 -c 5
- For demo of mode 3, compile and run HybridAttack with the arguments: -input testcases/test17.txt -m 160 -beta 3 -r 4 -c 1
